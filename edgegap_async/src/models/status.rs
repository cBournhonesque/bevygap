...
pub struct Status {
    ...
    pub ports: Option<std::collections::HashMap<String, models::PortMapping>>,
    /// The public IP
    ...
    pub sessions: Option<Vec<models::DeploymentSessionContext>>,
    #[serde(rename = "location", skip_serializing_if = "Option::is_none")]
    pub location: Option<Box<models::DeploymentLocation>>,
