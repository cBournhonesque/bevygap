...
pub async fn deployments_tags_create(
    configuration: &configuration::Configuration,
    request_id: &str,
    payload: models::DeploymentTagPayload,
) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsTagsCreateError> =
...
pub async fn deployments_tags_delete(
    configuration: &configuration::Configuration,
    request_id: &str,
    tag_name: &str,
) -> Result<(), Error<DeploymentsTagsDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsTagsDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployments_tags_list(
    configuration: &configuration::Configuration,
    request_id: &str,
) -> Result<models::DeploymentTagListResponse, Error<DeploymentsTagsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsTagsListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployments_tags_read(
    configuration: &configuration::Configuration,
    request_id: &str,
    tag_name: &str,
) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsReadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsTagsReadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployments_tags_update(
    configuration: &configuration::Configuration,
    request_id: &str,
    tag_name: &str,
    payload: models::DeploymentTagPayload,
) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsTagsUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
