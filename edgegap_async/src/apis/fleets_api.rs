...
pub async fn fleet_create(
    ...
    payload: models::FleetPostPayload,
) -> Result<models::FleetPostResponse, Error<FleetCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/fleet", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetCreateError> =
...
pub async fn fleet_delete(
    configuration: &configuration::Configuration,
    fleet_name: &str,
) -> Result<models::FleetDeleteResponse, Error<FleetDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        fleet_name = crate::apis::urlencode(fleet_name)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_get(
    configuration: &configuration::Configuration,
    fleet_name: &str,
) -> Result<models::FleetGetResponse, Error<FleetGetError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_link_app_version(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    app_name: &str,
    version_name: &str,
) -> Result<models::HorizontalScalerAppVersionLink, Error<FleetLinkAppVersionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetLinkAppVersionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_policies_create(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    payload: models::FleetPoliciesPostPayload,
) -> Result<models::FleetPoliciesPostResponse, Error<FleetPoliciesCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetPoliciesCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_policies_delete(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    policy_name: &str,
) -> Result<(), Error<FleetPoliciesDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        fleet_name = crate::apis::urlencode(fleet_name),
        policy_name = crate::apis::urlencode(policy_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetPoliciesDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_policies_get(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    policy_name: &str,
) -> Result<models::FleetPoliciesGetResponse, Error<FleetPoliciesGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetPoliciesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_policies_list(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    page: Option<i32>,
    limit: Option<i32>,
    x_fields: Option<&str>,
) -> Result<models::HorizontalScalerConstraintList, Error<FleetPoliciesListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetPoliciesListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_policies_update(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    policy_name: &str,
    payload: models::FleetPoliciesPatchPayload,
) -> Result<models::FleetPoliciesPatchPayload, Error<FleetPoliciesUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetPoliciesUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_unlink_app_version(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    app_name: &str,
    version_name: &str,
) -> Result<(), Error<FleetUnlinkAppVersionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetUnlinkAppVersionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleet_update(
    configuration: &configuration::Configuration,
    fleet_name: &str,
    payload: models::FleetPatchPayload,
) -> Result<models::FleetPatchResponse, Error<FleetUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<FleetUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fleets(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<models::FleetList, Error<FleetsError>> {
    let local_var_configuration = configuration;
