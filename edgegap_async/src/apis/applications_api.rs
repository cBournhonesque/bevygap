...
pub async fn app_version_delete(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
) -> Result<models::AppVersionDelete, Error<AppVersionDeleteError>> {
    ...
    let local_var_uri_str = format!(
        ...
        app_name = crate::apis::urlencode(app_name),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionDeleteError> =
...
pub async fn app_version_get(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
) -> Result<models::AppVersionPayload, Error<AppVersionGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_version_post(
    configuration: &configuration::Configuration,
    app_name: &str,
    payload: models::AppVersionPayload,
) -> Result<models::AppVersionCreateResponse, Error<AppVersionPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_version_whitelist_entry_delete(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
    entry_id: &str,
) -> Result<models::AppVersionWhitelistEntrySuccess, Error<AppVersionWhitelistEntryDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        app_name = crate::apis::urlencode(app_name),
        version_name = crate::apis::urlencode(version_name),
        entry_id = crate::apis::urlencode(entry_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionWhitelistEntryDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_version_whitelist_entry_get(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
    entry_id: &str,
) -> Result<models::AppVersionWhitelistEntry, Error<AppVersionWhitelistEntryGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionWhitelistEntryGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_version_whitelist_get(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
) -> Result<models::AppVersionWhitelistResponse, Error<AppVersionWhitelistGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionWhitelistGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_version_whitelist_post(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
    payload: models::AppVersionWhitelistEntryPayload,
) -> Result<models::AppVersionWhitelistEntrySuccess, Error<AppVersionWhitelistPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionWhitelistPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_versions_get(
    configuration: &configuration::Configuration,
    app_name: &str,
) -> Result<models::AppVersionList, Error<AppVersionsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn app_versions_patch(
    configuration: &configuration::Configuration,
    app_name: &str,
    version_name: &str,
    payload: models::AppVersionUpdatePayload,
) -> Result<models::AppVersionUpdateResponse, Error<AppVersionsPatchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<AppVersionsPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn application_delete(
    configuration: &configuration::Configuration,
    app_name: &str,
) -> Result<(), Error<ApplicationDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ApplicationDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn application_get(
    configuration: &configuration::Configuration,
    app_name: &str,
) -> Result<models::Application, Error<ApplicationGetError>> {
    let local_var_configuration = configuration;
...
pub async fn application_patch(
    configuration: &configuration::Configuration,
    app_name: &str,
    payload: models::ApplicationPatch,
) -> Result<models::Application, Error<ApplicationPatchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ApplicationPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn application_post(
    configuration: &configuration::Configuration,
    payload: models::ApplicationPost,
) -> Result<models::Application, Error<ApplicationPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ApplicationPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn applications_get(
    configuration: &configuration::Configuration,
) -> Result<models::Applications, Error<ApplicationsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ApplicationsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
