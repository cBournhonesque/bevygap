...
/// struct for typed errors of method [`lobby_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LobbyDeleteError {
    Status500(models::Error),
    Status401(models::Error),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`lobby_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LobbyListError {
    Status500(models::Error),
    Status401(models::Error),
    UnknownValue(serde_json::Value),
}
...
pub async fn lobby_create(
    ...
    payload: models::LobbyCreatePayload,
) -> Result<models::LobbyReadResponse, Error<LobbyCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/lobbies", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<LobbyCreateError> =
...
pub async fn lobby_delete(
    configuration: &configuration::Configuration,
    lobby_name: &str,
) -> Result<models::LobbyReadResponse, Error<LobbyDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        lobby_name = crate::apis::urlencode(lobby_name)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<LobbyDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn lobby_deploy(
    configuration: &configuration::Configuration,
    payload: models::LobbyDeployPayload,
) -> Result<models::LobbyReadResponse, Error<LobbyDeployError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/lobbies:deploy", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<LobbyDeployError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Get a named lobby.
pub async fn lobby_get(
    configuration: &configuration::Configuration,
    lobby_name: &str,
) -> Result<models::LobbyReadResponse, Error<LobbyGetError>> {
    let local_var_configuration = configuration;
...
pub async fn lobby_list(
    configuration: &configuration::Configuration,
) -> Result<models::LobbyReadResponse, Error<LobbyListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<LobbyListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn lobby_terminate(
    configuration: &configuration::Configuration,
    payload: models::LobbyTerminatePayload,
) -> Result<models::LobbyReadResponse, Error<LobbyTerminateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/lobbies:terminate", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<LobbyTerminateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
