...
/// struct for typed errors of method [`deployments_available`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeploymentsAvailableError {
...
pub async fn deploy(
    ...
    payload: models::DeployModel,
) -> Result<models::Request, Error<DeployError>> {
...
pub async fn deployment_delete(
    configuration: &configuration::Configuration,
    request_id: &str,
    container_log_storage: Option<&str>,
) -> Result<models::Delete, Error<DeploymentDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        request_id = crate::apis::urlencode(request_id)
    );
    let mut local_var_req_builder =
    ...
    if let Some(ref local_var_str) = container_log_storage {
        local_var_req_builder =
            local_var_req_builder.query(&[("container_log_storage", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentDeleteError> =
...
pub async fn deployment_get_logs(
    configuration: &configuration::Configuration,
    request_id: &str,
) -> Result<models::ApiModelContainerlogs, Error<DeploymentGetLogsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentGetLogsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployment_status_get(
    configuration: &configuration::Configuration,
    request_id: &str,
) -> Result<models::Status, Error<DeploymentStatusGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentStatusGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployment_update(
...
) -> Result<models::DeploymentUpdateResponse, Error<DeploymentUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployments_available(
    configuration: &configuration::Configuration,
    payload: models::DeploymentAvailablePayload,
) -> Result<models::DeploymentAvailableResponse, Error<DeploymentsAvailableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsAvailableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployments_bulk_delete(
    configuration: &configuration::Configuration,
    payload: models::DeploymentBulkStopPayload,
) -> Result<models::DeploymentBulkStopResponse, Error<DeploymentsBulkDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsBulkDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn deployments_get(
    configuration: &configuration::Configuration,
    query: Option<&str>,
) -> Result<models::Deployments, Error<DeploymentsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeploymentsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn self_deployment_delete(
    configuration: &configuration::Configuration,
    request_id: &str,
    access_point_id: i32,
    authorization: &str,
    container_log_storage: Option<&str>,
) -> Result<models::Delete, Error<SelfDeploymentDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<SelfDeploymentDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
