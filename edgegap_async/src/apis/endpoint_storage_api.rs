...
pub async fn endpoint_create(
    ...
    payload: models::EndpointStoragePostPayload,
) -> Result<models::EndpointStoragePostResponse, Error<EndpointCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<EndpointCreateError> =
...
pub async fn endpoint_delete(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
) -> Result<models::EndpointStorageDeleteResponse, Error<EndpointDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        endpoint_name = crate::apis::urlencode(endpoint_name)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<EndpointDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn endpoint_get(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
) -> Result<models::EndpointStorageGetResponse, Error<EndpointGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<EndpointGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn endpoint_update(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    payload: models::EndpointStoragePatchPayload,
) -> Result<models::EndpointStoragePatchResponse, Error<EndpointUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<EndpointUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn endpoints_list(
    ...
    limit: Option<i32>,
    x_fields: Option<&str>,
) -> Result<models::EndpointStorageListResponse, Error<EndpointsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(local_var_param_value) = x_fields {
        local_var_req_builder =
            local_var_req_builder.header("X-Fields", local_var_param_value.to_string());
    }
    if let Some(ref local_var_apikey) = local_var_configuration.api_key {
        let local_var_key = local_var_apikey.key.clone();
        let local_var_value = match local_var_apikey.prefix {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<EndpointsListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_create(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    payload: models::PullProfilePostPayload,
) -> Result<models::PullProfilePostResponse, Error<PullProfileCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_delete(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    pull_profile_name: &str,
) -> Result<(), Error<PullProfileDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        endpoint_name = crate::apis::urlencode(endpoint_name),
        pull_profile_name = crate::apis::urlencode(pull_profile_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_get(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    pull_profile_name: &str,
) -> Result<models::PullProfileGetResponse, Error<PullProfileGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_link_app_version(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    pull_profile_name: &str,
    app_name: &str,
    version_name: &str,
) -> Result<models::PullProfileAppVersionLinkResponse, Error<PullProfileLinkAppVersionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileLinkAppVersionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_list(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<models::PullProfilesListResponse, Error<PullProfileListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_unlink_app_version(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    pull_profile_name: &str,
    app_name: &str,
    version_name: &str,
) -> Result<(), Error<PullProfileUnlinkAppVersionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileUnlinkAppVersionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pull_profile_update(
    configuration: &configuration::Configuration,
    endpoint_name: &str,
    pull_profile_name: &str,
    payload: models::PullProfilePatchPayload,
) -> Result<models::PulloProfilePatchResponse, Error<PullProfileUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PullProfileUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
