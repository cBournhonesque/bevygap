...
pub async fn context_create_deployment_tag(
    configuration: &configuration::Configuration,
    request_id: &str,
    security_number: i32,
    authorization: &str,
    payload: models::ContextCreateDeploymentTagRequest,
) -> Result<models::ContextDeploymentTagResponse, Error<ContextCreateDeploymentTagError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ContextCreateDeploymentTagError> =
...
pub async fn context_delete_deployment_tag(
    configuration: &configuration::Configuration,
    tag_name: &str,
    request_id: &str,
    security_number: i32,
    authorization: &str,
) -> Result<(), Error<ContextDeleteDeploymentTagError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ContextDeleteDeploymentTagError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn context_get(
    ...
    security_number: i32,
    authorization: &str,
) -> Result<models::Deployment, Error<ContextGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<ContextGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
