...
pub async fn relay_session_create(
    configuration: &configuration::Configuration,
    payload: models::RelaySessionCreatePayload,
) -> Result<models::RelaySessionBaseResponse, Error<RelaySessionCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<RelaySessionCreateError> =
...
pub async fn relay_session_delete(
    configuration: &configuration::Configuration,
    session_id: &str,
) -> Result<(), Error<RelaySessionDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<RelaySessionDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn relay_session_get(
    configuration: &configuration::Configuration,
    session_id: &str,
) -> Result<models::RelaySessionBaseResponse, Error<RelaySessionGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<RelaySessionGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn relay_session_list(
    configuration: &configuration::Configuration,
) -> Result<models::RelaySessionListResponse, Error<RelaySessionListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<RelaySessionListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn relay_user_authorize(
    configuration: &configuration::Configuration,
    payload: models::RelayUserAuthorizePayload,
) -> Result<models::RelaySessionUserBaseResponse, Error<RelayUserAuthorizeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<RelayUserAuthorizeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Authorize a user on a Relay Session
pub async fn relay_user_revoke(
    configuration: &configuration::Configuration,
    payload: models::RelayUserRevokePayload,
) -> Result<models::RelaySessionBaseResponse, Error<RelayUserRevokeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<RelayUserRevokeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
