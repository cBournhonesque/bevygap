...
/// Delete a matchmaker.
pub async fn delete_matchmaker(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
) -> Result<(), Error<DeleteMatchmakerError>> {
    ...
    let local_var_uri_str = format!(
        ...
        matchmaker_name = crate::apis::urlencode(matchmaker_name)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteMatchmakerError> =
...
pub async fn delete_matchmaker_component(
    configuration: &configuration::Configuration,
    component_name: &str,
) -> Result<(), Error<DeleteMatchmakerComponentError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        component_name = crate::apis::urlencode(component_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeleteMatchmakerComponentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_matchmaker_component_env(
    configuration: &configuration::Configuration,
    component_name: &str,
    env_key: &str,
) -> Result<(), Error<DeleteMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        component_name = crate::apis::urlencode(component_name),
        env_key = crate::apis::urlencode(env_key)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeleteMatchmakerComponentEnvError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_matchmaker_managed_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    release_version: &str,
) -> Result<(), Error<DeleteMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        matchmaker_name = crate::apis::urlencode(matchmaker_name),
        release_version = crate::apis::urlencode(release_version)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeleteMatchmakerManagedReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_matchmaker_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    release_version: &str,
) -> Result<(), Error<DeleteMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeleteMatchmakerReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_matchmaker_release_config(
    configuration: &configuration::Configuration,
    config_name: &str,
) -> Result<(), Error<DeleteMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        config_name = crate::apis::urlencode(config_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<DeleteMatchmakerReleaseConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_component_list(
    configuration: &configuration::Configuration,
) -> Result<models::MatchmakerComponentListResponse, Error<GetComponentListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetComponentListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_envs_list(
    configuration: &configuration::Configuration,
    component_name: &str,
) -> Result<models::MatchmakerComponentEnvListResponse, Error<GetEnvsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetEnvsListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
) -> Result<models::MatchmakerResponse, Error<GetMatchmakerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker_component(
    configuration: &configuration::Configuration,
    component_name: &str,
) -> Result<models::MatchmakerComponentResponse, Error<GetMatchmakerComponentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerComponentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker_component_env(
    configuration: &configuration::Configuration,
    component_name: &str,
    env_key: &str,
) -> Result<models::MatchmakerComponentEnvsResponse, Error<GetMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerComponentEnvError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker_list(
    configuration: &configuration::Configuration,
) -> Result<models::MatchmakerListResponse, Error<GetMatchmakerListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker_managed_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    release_version: &str,
) -> Result<models::MatchmakerManagedReleaseResponse, Error<GetMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerManagedReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    release_version: &str,
) -> Result<models::MatchmakerReleaseResponse, Error<GetMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_matchmaker_release_config(
    configuration: &configuration::Configuration,
    config_name: &str,
) -> Result<models::MatchmakerReleaseConfigResponse, Error<GetMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetMatchmakerReleaseConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_release_configs_list(
    configuration: &configuration::Configuration,
) -> Result<models::MatchmakerComponentEnvListResponse, Error<GetReleaseConfigsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetReleaseConfigsListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_release_list(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
) -> Result<models::MatchmakerComponentEnvListResponse, Error<GetReleaseListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetReleaseListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_matchmaker(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    payload: models::MatchmakerUpdate,
) -> Result<models::MatchmakerResponse, Error<PatchMatchmakerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PatchMatchmakerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_matchmaker_component(
    configuration: &configuration::Configuration,
    component_name: &str,
    payload: models::MatchmakerComponentUpdate,
) -> Result<models::MatchmakerComponentResponse, Error<PatchMatchmakerComponentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PatchMatchmakerComponentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_matchmaker_component_env(
    configuration: &configuration::Configuration,
    component_name: &str,
    env_key: &str,
    payload: models::MatchmakerComponentEnvsUpdate,
) -> Result<models::MatchmakerComponentEnvsResponse, Error<PatchMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PatchMatchmakerComponentEnvError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_matchmaker_managed_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    release_version: &str,
    payload: models::MatchmakerManagedReleaseUpdate,
) -> Result<models::MatchmakerManagedReleaseResponse, Error<PatchMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PatchMatchmakerManagedReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_matchmaker_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    release_version: &str,
    payload: models::MatchmakerReleaseUpdate,
) -> Result<models::MatchmakerReleaseResponse, Error<PatchMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PatchMatchmakerReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_matchmaker_release_config(
    configuration: &configuration::Configuration,
    config_name: &str,
    payload: models::MatchmakerReleaseConfigUpdate,
) -> Result<models::MatchmakerReleaseConfigResponse, Error<PatchMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PatchMatchmakerReleaseConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_matchmaker(
    configuration: &configuration::Configuration,
    payload: models::MatchmakerCreate,
) -> Result<models::MatchmakerResponse, Error<PostMatchmakerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PostMatchmakerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_matchmaker_component(
    configuration: &configuration::Configuration,
    payload: models::MatchmakerComponentCreate,
) -> Result<models::MatchmakerComponentResponse, Error<PostMatchmakerComponentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PostMatchmakerComponentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_matchmaker_component_env(
    configuration: &configuration::Configuration,
    component_name: &str,
    payload: models::MatchmakerComponentEnvsCreate,
) -> Result<models::MatchmakerComponentEnvsResponse, Error<PostMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PostMatchmakerComponentEnvError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_matchmaker_managed_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    payload: models::MatchmakerManagedReleaseCreate,
) -> Result<models::MatchmakerManagedReleaseResponse, Error<PostMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PostMatchmakerManagedReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_matchmaker_release(
    configuration: &configuration::Configuration,
    matchmaker_name: &str,
    payload: models::MatchmakerReleaseCreate,
) -> Result<models::MatchmakerReleaseResponse, Error<PostMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PostMatchmakerReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_matchmaker_release_config(
    configuration: &configuration::Configuration,
    payload: models::MatchmakerReleaseConfigCreate,
) -> Result<models::MatchmakerReleaseConfigResponse, Error<PostMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<PostMatchmakerReleaseConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
